      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  ...
                  <div class="col-md act">
                    ...
                    <br><br>
                    <a href="transfermoney.php"><button class="btn btn-success"><strong><b>View All customer</b></strong></button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/money.png" class="img-fluid">
                    <br>
                    <a href="transfermoney.php"><button class="btn btn-warning"><strong><b>Tranfer Money</b></strong></button></a>
                  </div>
                  <div class="col-md act">
